...
# %%
stats = pd.DataFrame(player_stats, columns=["Player Name", "Position","Age","Team","G","GS","MP","FG","FGA","FGP","3P","3PA","3PP","2P","2PA","2PP","eFG%","FT","FTA","FTP","ORB","DRB","TRB","AST","STL","BLK","TOV","PF","PTS"])
#Printing to CSV
